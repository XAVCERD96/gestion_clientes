...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h5 class="card-title"><?php echo isset($id) ? "Actualizar detalles de cliente - ".$client_code : 'Agregar Nuevo Cliente' ?></h5>
    </div>
    <div class="card-body">
        <div class="container-fluid">
            <form action="" id="client-form">
                ...
                <div class="col-md-12">
                    ...
                    <fieldset class="border-bottom border-info">
                        <legend class="text-info">Imagen de Cliente</legend>
                        <div class="row">
                            <div class="form-group col-sm-4">
    ...
    <div class="card-footer text-center">
        <button class="btn btn-flat btn-sn btn-primary" type="submit" form="client-form">Guardar</button>
        <a class="btn btn-flat btn-sn btn-dark" href="<?php echo base_url."admin?page=client" ?>">Cancelar</a>
    </div>
</div>
<script>
    $(function(){
