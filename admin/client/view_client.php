...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        <div class="container-fluid" id="print_out">
            ...
            <h3 class="text-info">Cliente: <b><?php echo isset($client_code) ? $client_code :'' ?></b></h3>
                <div class="row">
                    <div class="col-md-4">
    ...
    <div class="card-footer text-center">
            ...
            <button class="btn btn-flat btn-sn btn-primary bg-lightblue" id="reset_password" type="button"><i class="fa fa-key"></i> Resetear Contraseña</button>
            <a class="btn btn-flat btn-sn btn-primary" href="<?php echo base_url."admin?page=client/manage_client&id=".$id ?>"><i class="fa fa-edit"></i> Editar</a>
            <a class="btn btn-flat btn-sn btn-dark" href="<?php echo base_url."admin?page=client" ?>">Volver a la Lista de Clientes</a>
    </div>
</div>
<script>
    $(function(){
        $('#reset_password').click(function(){
            _conf("¿Estás segur@ de restablecer la contraseña de <b>Client@ - <?php echo $client_code ?></b>?",'reset_password')
        })
        $('#print').click(function(){
            start_loader()
            var _el = $('<div>')
            var _head = $('head').clone()
                _head.find('title').text("Detalles de Cliente - Imprimir Vista")
            ...
            _el.append('<div class="d-flex justify-content-center">'+
                      ...
                      '<h4 class="text-center">Detalles de Cliente</h4>'+
                      '</div>'+
                      '<div class="col-1 text-right">'+
                      '</div>'+
                      '</div><hr/>')
