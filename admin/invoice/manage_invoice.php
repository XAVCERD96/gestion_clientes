...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h5 class="card-title"><?php echo isset($id) ? "Actualizar Factura N° ".$invoice_code : 'Crear Nueva Factura' ?></h5>
    </div>
    <div class="card-body">
                ...
                <div class="col-md-12">
                    <fieldset class="border-bottom border-info">
                        <div class="row">
                            <div class="form-group col-sm-4">
                                ...
                                <select name="client_id" id="client_id" class="custom-select custom-select-sm rounded-0 select2" data-placeholder="Selecciona tu Cliente" required>
                    ...
                    <fieldset class="border-bottom border-info">
                        ...
                        <div class="row align-items-end">
                            <div class="form-group col-sm-4">
                                <label for="service_id" class="control-label text-info">Servicio</label>
                                <select id="service_id" class="custom-select custom-select-sm rounded-0 select2" data-placeholder="Selecciona servicio aquí">
                            ...
                            <div class="form-group col-sm-4">
                               <button class="btn btn-flat btn-primary btn sm" type="button" id="add_to_list"><i class="fa fa-plus"></i> Agregar a la lista</button>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="status" id="status" class="custom-select selevt">
                                    ...
                                    <option value="1" <?php echo isset($status) && $status == 1 ? 'selected' : '' ?>>Pago</option>
                                </select>
                            </div>
                            <?php endif; ?>
                        </div>
    ...
    <div class="card-footer text-center">
        <button class="btn btn-flat btn-sn btn-primary" type="submit" form="invoice-form">Guardar</button>
        <a class="btn btn-flat btn-sn btn-dark" href="<?php echo base_url."admin?page=invoice" ?>">Cancelar</a>
    </div>
</div>
    ...
    $(function(){
        ...
        $('#invoice-form').submit(function(e){
            ...
            var _this = $(this)
             ...
             if($('#service-list tbody tr').length <= 0){
                 alert_toast("Agregue al menos 1 servicio en la lista.","warning")
                 return false;
             }
			start_loader();
			$.ajax({
        ...
        $('#add_to_list').click(function(){
            ...
            if($('#service-list tbody tr[data-id="'+service_id+'"]').length > 0){
                alert_toast("El servicio ya existe en la lista.","warning")
                return false;
            }
