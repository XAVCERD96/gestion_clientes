...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h5 class="card-title">Actualizar Información de Usuario y Credenciales</h5>
    </div>
    <div class="card-body">
            ...
            <form action="" id="client-form">
                ...
                <div class="col-md-12">
                    <fieldset class="border-bottom border-info">
                        <legend class="text-info">Información Personal</legend>
                        <div class="row">
                            <div class="form-group col-sm-4">
                                <label for="lastname" class="control-label text-info">Apellido</label>
                            ...
                            <div class="form-group col-sm-4">
                                <label for="firstname" class="control-label text-info">Nombre</label>
                            ...
                            <div class="form-group col-sm-4">
                                <label for="middlename" class="control-label text-info">Segundo Nombre</label>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-4">
                                <label for="gender" class="control-label text-info">Género</label>
                            ...
                            <div class="form-group col-sm-4">
                                <label for="dob" class="control-label text-info">Fecha de Nacimiento</label>
                                <input type="date" class="form-control form-control-sm rounded-0" id="dob" name="dob" value="<?php echo isset($dob) ? $dob : '' ?>" required>
                            </div>
                            <div class="form-group col-sm-4">
                                <label for="contact" class="control-label text-info"># Contacto</label>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <label for="address" class="control-label text-info">Dirección</label>
                                <textarea type="text" class="form-control form-control-sm rounded-0" id="address" name="address" required placeholder="Calle, número de unidad de apartamento / edificio, ciudad, estado / provincia, código postal"><?php echo isset($address) ? $address : '' ?></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-sm-4">
                    ...
                    <fieldset class="border-bottom border-info">
                        <legend class="text-info">Actualizar Imagen</legend>
                        <div class="row">
                            <div class="form-group col-sm-4">
                                <div class="custom-file rounded-0">
                                    ...
                                    <label class="custom-file-label rounded-0" for="avatar">Escoger archivo</label>
                                </div>
                            </div>
                    ...
                    <fieldset class="border-bottom border-info">
                        <legend class="text-info">Actualizar Contraseña</legend>
                        <div class="row">
                            <div class="form-group col-sm-4">
                                    <label for="password" class="control-label text-info">Nueva Contraseña</label>
                                    <input type="password" class="form-control form-control-sm rounded-0" id="password" name="password">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-sm-4">
                                <label for="cpassword" class="control-label text-info">Confirmar Nueva Contraseña</label>
                                <input type="password" class="form-control form-control-sm rounded-0" id="cpassword" name="cpassword">
                            </div>
                        </div>
                        <small class="text-info"><i>Deje los campos anteriores en blanco si no desea actualizar su contraseña.</i></small>
                    </fieldset>
                    <fieldset class="border-bottom border-info">
                        <legend class="text-info">Confirmar Usuario</legend>
                        <div class="row">
                            <div class="form-group col-sm-4">
                                    <label for="cur_password" class="control-label text-info">Ingresa Contraseña Actual</label>
    ...
    <div class="card-footer text-center">
        <button class="btn btn-flat btn-sn btn-primary" type="submit" form="client-form">Actualizar</button>
